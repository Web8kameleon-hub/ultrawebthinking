...
exports.ultraSearchAPI = exports.UltraSearchAPI = void 0;
const express_1 = __importDefault(require("express"));
const cors_1 = __importDefault(require("cors"));
class UltraSearchAPI {
    constructor() {
    ...
    setupRoutes() {
        ...
        // Bulk search
        this.app.post('/api/search/bulk', (req, res) => {
...
exports.UltraSearchAPI = UltraSearchAPI;
// Export instance
exports.ultraSearchAPI = new UltraSearchAPI();
// Start if run directly
if (require.main === module) {
    exports.ultraSearchAPI.start().catch(console.error);
}
