...
export const AGICore: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' } as any}>
          <div style={{
            width: '16px',
            height: '16px',
      ...
      >
        ...
        <div style={{
          ...
          {cognitiveModules.map((module, index) => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '15px' } as any}>
                <span style={{ fontSize: '24px', marginRight: '12px' } as any}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: '16px', fontWeight: 600, color: '#d4af37' } as any}>
                  {module.efficiency}%
                </span>
              </div>
      ...
      >
        ...
        <div style={{
          ...
          {logs.map((log, index) => (
            ...
            >
              <span style={{ color: '#6b7280' } as any}>
                [{new Date().toLocaleTimeString()}]
              </span>
              {' '}
              <span style={{ color: '#22c55e' } as any}>INFO:</span>
              {' '}
              {log}
            </motion.div>
          ))}
