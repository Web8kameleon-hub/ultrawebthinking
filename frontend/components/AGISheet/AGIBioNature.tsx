    ...
    >
          ...
          <div className={styles.controls}>
            ...
            <div className={styles.researchBox}>
              <input
                ...
                onKeyPress={(e: any) => e.key === 'Enter' && performSpecimenResearch(researchQuery)}
              />
              <motion.button
            ...
            >
              <div className={styles.metricHeader}>
                ...
                <span 
                  ...
                  style={{ color: getThreatLevelColor(ecosystemMetrics.threatLevel) } as any}
                >
            ...
            >
              <div className={styles.specimenHeader}>
                ...
                <div 
                  ...
                  style={{ color: getHealthStatusColor(specimen.properties.healthStatus) } as any}
                >
      ...
      >
        <div className={styles.statusIndicators}>
          ...
          <div className={styles.statusItem}>
            🧬 Specimens: {(biologicalData?.length ?? 0)}
          </div>
          <div className={styles.statusItem}>
            💊 Medical Insights: {(medicalInsights?.length ?? 0)}
          </div>
          <div className={styles.statusItem}>
