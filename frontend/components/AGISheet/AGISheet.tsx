  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ color: '#d4af37', fontSize: '12px', fontWeight: 600 } as any}>
          {selectedCell || 'A1'}
        </span>
        <input
          type="text"
      ...
      >
        <div style={{
          ...
          {/* Column Headers */}
          <div style={{ display: 'flex', position: 'sticky', top: 0, zIndex: 10 } as any}>
            <div style={{
              ...getCellStyle(-1, -1),
          ...
          {Array.from({ length: height }, (_, rowIndex) => (
            <div key={`row-${rowIndex}`} style={{ display: 'flex' } as any}>
              {/* Row Header */}
              <div style={{
