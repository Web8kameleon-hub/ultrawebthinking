  ...
  return (
    <section style={{
      ...
      >
        ...
        >
          {/* Input section */}
          <div style={{ marginBottom: '24px' } as any}>
            <motion.input
              type="text"
            ...
            {state.error && (
              <motion.p
                ...
                style={{ color: '#ef4444', marginBottom: '16px', fontSize: '14px' } as any}
              >
                {state.error}
              </motion.p>
            )}
        ...
        >
          {[
            ...
            >
              <div style={{ fontSize: '24px', marginBottom: '8px' } as any}>{metric.icon}</div>
              <div style={{ fontSize: '18px', fontWeight: 600, color: modeConfig[state.mode].color } as any}>{metric.value}</div>
              <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' } as any}>{metric.label}</div>
            </motion.div>
          ))}
        </motion.div>
      </motion.div>
