        ...
        {isOpen && (
          ...
          >
            ...
            <div style={{ marginBottom: '20px' } as any}>
              <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', margin: '0 0 10px 0' } as any}>
                ⚡ Web8 Quick Menu
              </h2>
              <div style={{ 
                display: 'grid', 
                ...
                <div>
                  <div style={{ fontWeight: 'bold' } as any}>Active: {activeProcesses}</div>
                  <div style={{ opacity: 0.8 } as any}>Processes</div>
                </div>
                <div>
                  <div style={{ fontWeight: 'bold' } as any}>{totalMemory}MB</div>
                  <div style={{ opacity: 0.8 } as any}>Memory</div>
                </div>
                <div>
                  <div style={{ fontWeight: 'bold' } as any}>{totalCpu}%</div>
                  <div style={{ opacity: 0.8 } as any}>CPU</div>
                </div>
              </div>
            </div>
            ...
            {/* Process List */}
            <div style={{ display: 'grid', gap: '10px' } as any}>
                ...
                >
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' } as any}>
                      <span style={{ fontSize: '18px' } as any}>{process.icon}</span>
                      <div>
                        <div style={{ fontWeight: 'bold', fontSize: '14px' } as any}>
                          {process.name}
                        </div>
                        <div style={{ fontSize: '12px', opacity: 0.7 } as any}>
                          {process.description}
                        </div>
                      </div>
                    </div>
                    <div style={{ textAlign: 'right' } as any}>
                      <div style={{ fontSize: '16px' } as any}>
                        {getStatusIcon(process.status)}
                      </div>
                      <div style={{ fontSize: '10px', opacity: 0.8 } as any}>
                        {process.status}
                      </div>
                    </div>
                  </div>
