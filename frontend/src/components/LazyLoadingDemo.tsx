...
export const ViewportLazyExample = () => {
  return (
    <div style={{ height: '200vh' } as any}>
      <h2>Scroll down to load component</h2>
      <div style={{ marginTop: '100vh' } as any}>
        <LazyLoader 
          component="AGIEco"
          variant="neural"
          priority="low"
...
const CustomAGIEngine = registerLazyComponent({
  ...
  loader: async () => {
    ...
    return {
      default: () => (
        <div style={{ padding: '20px', background: '#1a1a2e', color: '#fff' } as any}>
...
export const IndustrialTabExample = () => {
  ...
  return (
    <div style={{ width: '100%', height: '600px' } as any}>
      <div style={{ display: 'flex', borderBottom: '2px solid #333', marginBottom: '20px' } as any}>
        {tabs.map(tab => (
          <button
            key={tab.id}
    ...
    <div>
      ...
      <div style={{ marginBottom: '20px' } as any}>
        {Object.entries(loadTimes).map(([component, time]) => (
          <div key={component} style={{ color: '#666' } as any}>
...
export const ErrorHandlingExample = () => {
  ...
  return (
    <div>
      ...
      {error && (
        <div style={{ color: 'red', marginBottom: '20px' } as any}>
          Error: {error}
        </div>
      )}
...
export const LazyLoadingDemo = () => {
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' } as any}>
      ...
      <div style={{ display: 'grid', gap: '40px', marginTop: '30px' } as any}>
        <BasicLazyExample />
        <ViewportLazyExample />
        <PreloadExample />
        <CustomLazyExample />
