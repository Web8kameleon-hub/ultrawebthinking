/**
 * EuroWeb AGIEco Ultra - Environmental AI Tab System
    ...
    <div style={{
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ color: '#22c55e', fontWeight: 600 } as any}>
          ...
          >
            ...
            <div style={{ marginBottom: '16px' } as any}>
              <div style={{
                ...
                <span style={{ fontSize: '14px', color: '#cbd5e1' } as any}>Sustainability</span>
                <span style={{ fontSize: '14px', fontWeight: 600, color: '#22c55e' } as any}>
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ color: '#10b981', fontSize: '14px', fontWeight: 600, marginBottom: '8px' } as any}>
              ♻️ Waste Reduction
            </div>
            <div style={{ color: '#f8fafc', fontSize: '24px', fontWeight: 700 } as any}>
              78%
      ...
      >
        ...
        <div style={{
          ...
          <table style={{
            ...
            <thead>
              <tr style={{ background: 'rgba(59, 130, 246, 0.1)' } as any}>
                <th style={{ padding: '12px', textAlign: 'left', color: '#3b82f6', fontWeight: 600 } as any}>Location</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#3b82f6', fontWeight: 600 } as any}>Temp (°C)</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#3b82f6', fontWeight: 600 } as any}>Humidity</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#3b82f6', fontWeight: 600 } as any}>Pressure</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#3b82f6', fontWeight: 600 } as any}>Wind</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#3b82f6', fontWeight: 600 } as any}>Air Quality</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#3b82f6', fontWeight: 600 } as any}>CO₂ (ppm)</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#3b82f6', fontWeight: 600 } as any}>Prediction</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#3b82f6', fontWeight: 600 } as any}>Risk</th>
              </tr>
            </thead>
            <tbody>
              {climateData.map((data, index) => (
                <tr key={data.id} style={{
                  ...
                  <td style={{ padding: '12px', color: '#f8fafc', fontWeight: 500 } as any}>{data.location}</td>
                  <td style={{ padding: '12px', textAlign: 'center', color: '#fbbf24' } as any}>{data.temperature}°</td>
                  <td style={{ padding: '12px', textAlign: 'center', color: '#06b6d4' } as any}>{data.humidity}%</td>
                  <td style={{ padding: '12px', textAlign: 'center', color: '#cbd5e1' } as any}>{data.pressure} hPa</td>
                  <td style={{ padding: '12px', textAlign: 'center', color: '#10b981' } as any}>{data.windSpeed} km/h</td>
                  <td style={{ 
                    padding: '12px', 
                    textAlign: 'center',
                  ...
                  <td style={{ padding: '12px', textAlign: 'center', color: '#ef4444' } as any}>{data.co2Level}</td>
                  <td style={{ padding: '12px', textAlign: 'center', color: '#8b5cf6' } as any}>{data.prediction}</td>
                  <td style={{ 
                    padding: '12px', 
                    textAlign: 'center',
      ...
      >
        ...
        <div style={{
          ...
          <table style={{
            ...
            <thead>
              <tr style={{ background: 'rgba(16, 185, 129, 0.1)' } as any}>
                <th style={{ padding: '12px', textAlign: 'left', color: '#10b981', fontWeight: 600 } as any}>Category</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#10b981', fontWeight: 600 } as any}>Current Usage</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#10b981', fontWeight: 600 } as any}>Optimized</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#10b981', fontWeight: 600 } as any}>Savings (%)</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#10b981', fontWeight: 600 } as any}>Carbon (kg CO₂)</th>
                <th style={{ padding: '12px', textAlign: 'center', color: '#10b981', fontWeight: 600 } as any}>Status</th>
                <th style={{ padding: '12px', textAlign: 'left', color: '#10b981', fontWeight: 600 } as any}>AI Recommendation</th>
              </tr>
            </thead>
            <tbody>
              {sustainabilityData.map((data, index) => (
                <tr key={data.id} style={{
                  ...
                  <td style={{ padding: '12px', color: '#f8fafc', fontWeight: 500 } as any}>{data.category}</td>
                  <td style={{ padding: '12px', textAlign: 'center', color: '#ef4444' } as any}>{data.currentUsage.toLocaleString()}</td>
                  <td style={{ padding: '12px', textAlign: 'center', color: '#22c55e' } as any}>{data.optimizedUsage.toLocaleString()}</td>
                  <td style={{ 
                    padding: '12px', 
                    textAlign: 'center', 
                    color: '#10b981',
                  ...
                  <td style={{ padding: '12px', textAlign: 'center', color: '#f59e0b' } as any}>{data.carbonFootprint.toLocaleString()}</td>
                  <td style={{ 
                    padding: '12px', 
                    textAlign: 'center'
                  } as any}>
