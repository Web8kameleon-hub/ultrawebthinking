...
const AGISpreadsheetEngine: React.FC = () => {
  ...
  const generateGrid = (rows = 15, cols = 8): React.ReactElement[] => {
    ...
    // Header row
    grid.push(
      <div key="header" style={{ display: 'flex', background: 'rgba(45, 52, 70, 0.9)' } as any}>
        <div style={{
          width: '50px',
          height: '35px',
    ...
    for (let row = 1; row <= rows; row++) {
      const rowElement = (
        <div key={row} style={{ display: 'flex' } as any}>
          <div style={{
            width: '50px',
            height: '35px',
            border: '1px solid rgba(59, 130, 246, 0.3)',
  ...
  return (
    <div style={{
      ...
      <motion.div
        ...
        style={{ marginBottom: '24px' } as any}
      >
        <h3 style={{
          fontSize: '18px',
          fontWeight: 600,
          ...
          {spreadsheetTemplates.map((template, index) => (
            ...
            >
              <div style={{
                ...
                <span style={{ fontSize: '24px' } as any}>{template.icon}</span>
                <div>
                  <h4 style={{
                    fontSize: '16px',
                    fontWeight: 600,
      ...
      >
        ...
        <div style={{
          ...
          <input
            type="text"
            defaultValue="Enter formula or value..."
            style={{
              flex: 1,
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ color: '#f8fafc', fontSize: '12px' } as any}>
