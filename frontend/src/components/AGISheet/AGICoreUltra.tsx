    ...
    <div style={{
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ color: '#6366f1', fontWeight: 600 } as any}>
          ...
          >
            ...
            <div style={{ marginBottom: '16px' } as any}>
              <div style={{
                ...
                <span style={{ fontSize: '14px', color: '#cbd5e1' } as any}>Performance</span>
                <span style={{ fontSize: '14px', fontWeight: 600, color: '#6366f1' } as any}>
                  {module.performance}%
                </span>
              </div>
              <div style={{
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ color: '#6366f1', fontSize: '14px', fontWeight: 600, marginBottom: '8px' } as any}>
              ⏱️ System Uptime
            </div>
            <div style={{ color: '#f8fafc', fontSize: '24px', fontWeight: 700 } as any}>
              99.9%
