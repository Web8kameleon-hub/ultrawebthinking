  ...
  if (!result) {
    return (
      <div style={{
        ...
        <div style={{ fontSize: '64px', marginBottom: '24px' } as any}>🏥</div>
        <h3 style={{ fontSize: '24px', fontWeight: 600, marginBottom: '12px', color: '#22c55e' } as any}>
          AGIXmed e gatshme për analizë
        </h3>
        <p style={{ fontSize: '16px' } as any}>
