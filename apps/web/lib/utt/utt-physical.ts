...
export class UTTPhysicalTokens {
  ...
  async createPhysicalToken(
    ...
    try {
      ...
      console.error("❌ Failed to create physical token:", err)
      throw error
    }
  }
  ...
  async activatePhysicalToken(activationRequest: ActivationRequest): Promise<boolean> {
    try {
      ...
      console.error("❌ Failed to activate physical token:", err)
      throw error
    }
  }
  ...
  async transferToPhysicalToken(tokenId: string, amount: number): Promise<boolean> {
    try {
      ...
      console.error("❌ Failed to transfer to physical token:", err)
      throw error
    }
  }
  ...
  async transferFromPhysicalToken(
    ...
    try {
      ...
      console.error("❌ Failed to transfer from physical token:", err)
      throw error
    }
  }
  ...
  async burnPhysicalToken(tokenId: string, securityPin?: string): Promise<boolean> {
    try {
      ...
      console.error("❌ Failed to burn physical token:", err)
      throw error
    }
  }
  ...
  private async startNFCScanner(): Promise<void> {
    try {
      ...
      console.warn("⚠️ NFC scanner failed to initialize:", err)
    }
  }
  ...
  private async startQRScanner(): Promise<void> {
    try {
      ...
      console.warn("⚠️ QR scanner failed to initialize:", err)
    }
  }
