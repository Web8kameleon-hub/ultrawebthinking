        ...
        <div style={{
          ...
          <div style={{
            ...
            background: `linear-gradient(90deg, 
              ${metrics.cognitiveLoad < 30 ? '#00ff00' : 
                metrics.cognitiveLoad < 70 ? '#ffaa00' : '#ff4444'} 0%, 
              ${metrics.cognitiveLoad < 30 ? '#00ff0088' : 
                metrics.cognitiveLoad < 70 ? '#ffaa0088' : '#ff444488'} 100%)`,
            transition: 'all 0.3s ease',
            boxShadow: `0 0 10px ${metrics.cognitiveLoad < 30 ? '#00ff00' : 
              metrics.cognitiveLoad < 70 ? '#ffaa00' : '#ff4444'}44`
          }} />
