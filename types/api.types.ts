...
export interface ApiBuilder {
  ...
  setAuth(auth: any): ApiBuilder;
  setHeaders(headers: Record<string, string>): ApiBuilder;
  enableCache(config?: any): ApiBuilder;
  enableRateLimit(config: any): ApiBuilder;
...
export type ApiEvent = 
  ...
  | { type: 'rate_limit_exceeded'; data: { request: ApiRequest; limit: any } }
  ...
  | { type: 'webhook_delivered'; data: { delivery: WebhookDelivery } }
  | { type: 'webhook_failed'; data: { delivery: WebhookDelivery; error: string } }
