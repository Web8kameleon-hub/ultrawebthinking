...
import { AGIBio } from './AGIBio';
import styles from './AGIBioDemo.module.css';
              ...
              <div className={styles.settingsRow}>
                <div className={styles.settingItem}>
                  ...
                  <select 
                    ...
                    title="Select data source for analysis"
                    aria-label="Select data source for biological analysis"
                  >
