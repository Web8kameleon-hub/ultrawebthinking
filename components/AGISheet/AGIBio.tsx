...
import styles from './AGIBio.module.css';
        ...
        <div className={styles.headerContent}>
          ...
          <div className={styles.controls}>
            <select 
              ...
              title="Select biological category"
              aria-label="Select biological category to filter specimens"
            >
          ...
          <div className={styles.ecosystemGrid}>
            ...
            >
              <div className={styles.metricHeader}>
                ...
                <span 
                  className={`${styles.threatLevel} ${styles[ecosystemMetrics.threatLevel]}`}
                >
          ...
          {filteredData.map((specimen, index) => (
            ...
            >
              <div className={styles.specimenHeader}>
                ...
                <div 
                  className={`${styles.healthStatus} ${styles[specimen.properties.healthStatus]}`}
                >
