      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            ...
            { icon: '✈️', label: 'Aviation', active: false, href: '/aviation' },
            { icon: '�', label: 'Status', active: false, href: '/status' },
            { icon: '�', label: 'UTT', active: false, href: '/test-utt' },
            { icon: '🧠', label: 'AGI', active: false, href: '/agi-demo' },
            { icon: '�️', label: 'Guardian', active: false, href: '/guardian' },
            { icon: '�', label: 'Browser', active: false, href: '/browser' },
            { icon: '⚡', label: 'OpenMind', active: false, href: '/openmind' }
          ].map((item, index) => (
            <a
              key={index}
              href={item.href}
