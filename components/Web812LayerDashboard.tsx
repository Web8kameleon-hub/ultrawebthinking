      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ margin: '5px 0 0 0', opacity: 0.8 }}>
            Status: <span style={{ color: '#4ade80', fontWeight: 'bold' }}>
      ...
      {systemData?.agiCore && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.8rem', opacity: 0.7 }}>Neural Connections</div>
          </div>
          <div style={{
            padding: '15px',
            background: 'rgba(255,255,255,0.08)',
            ...
            <div style={{ fontSize: '0.8rem', opacity: 0.7 }}>Processing Speed</div>
          </div>
          <div style={{
            padding: '15px',
            background: 'rgba(255,255,255,0.08)',
            ...
            <div style={{ fontSize: '0.8rem', opacity: 0.7 }}>Average Load</div>
          </div>
          <div style={{
            padding: '15px',
            background: 'rgba(255,255,255,0.08)',
